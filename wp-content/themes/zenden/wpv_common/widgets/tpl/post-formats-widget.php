<ul class="clearfix">
	<li class="post-format-pad"><a title="<?php _e('Standard', 'wpv')?>" href="<?php echo add_query_arg( 'format_filter','standard',home_url()) ?>" class="standard"> <?php _e('Standard', 'wpv')?></a></li>
	<?php
