	...
	public function register_sidebars() {
		foreach($this->sidebars as $id=>$name) {
			foreach($this->places as $place) {
				register_sidebar(array(
					...
					'before_title' => apply_filters('wpv_before_widget_title', '<h4 class="widget-title-side">', 'body'),
		...
		for($i=1; $i<=(int)wpv_get_option('footer-sidebars'); $i++) {
			register_sidebar(array(
				...
				'before_widget' => '<section id="%1$s" class="widget %2$s">',
				'after_widget' => '</section>',
				'before_title' => apply_filters('wpv_before_widget_title', '<h4 class="widget-title-side">', 'footer'),
		...
		for($i=1; $i<=(int)wpv_get_option('header-sidebars'); $i++) {
			register_sidebar(array(
				...
				'before_widget' => '<section id="%1$s" class="widget %2$s">',
				'after_widget' => '</section>',
				'before_title' => apply_filters('wpv_before_widget_title', '<h4 class="widget-title-side">', 'header'),
		...
		if(wpv_get_option('feedback-type') == 'sidebar') {
			register_sidebar(array(
				...
				'before_widget' => '<section id="%1$s" class="widget %2$s">',
				'after_widget' => '</section>',
				'before_title' => apply_filters('wpv_before_widget_title', '<h4 class="widget-title-side">', 'feedback'),
