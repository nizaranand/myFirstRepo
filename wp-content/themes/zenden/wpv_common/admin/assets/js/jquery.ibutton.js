...
;(function($){
    ...
    var $container = $input.parent()
		...
		var width, handleRight;
		var width_calcs = 0;
		
		var calculateWidth = function() {
			width_calcs++;
			
			// if we need to do some resizing, get the widths every time, as premature optimizations is the root of all evil
			...
			handleRight = width.container - width.handle - 6;
		}
