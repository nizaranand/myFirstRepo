...
<div id="item-header-content" class="member-single-header">
	<h1 class="entry-title fn"><a href="<?php bp_user_link() ?>"><?php bp_displayed_user_fullname() ?></a></h1> <span class="highlight">(@<?php bp_displayed_user_username() ?>) <span>?</span> </span>
