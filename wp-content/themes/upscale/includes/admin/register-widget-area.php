...
{	
	...
	function avia_dummy_widget($number)
	{
		switch($number)
		{
			case 1:
			?>
				<h3><?php _e('Interesting links','avia_framework');?></h3>
				<p><?php _e('Besides are some interesting links for you! Enjoy your stay :)','avia_framework');?></p>
			<?php
			break;
			...
			case 4: 
				...
				echo "<h3>" . __('Archive','avia_framework') . "</h3>";
				echo "<ul>";
			...
			case 3: 
				echo "<div class='widget widget_archive'>";
				echo "<h3>" . __('Categories','avia_framework') . "</h3>";
				echo "<ul>";
			...
			case 2: 
				echo "<div class='widget widget_archive'>";
				echo "<h3>" . __('Pages','avia_framework') . "</h3>";
				echo "<ul>";
			...
			case 5: 
				echo "<div class='widget widget_archive'>";
				echo "<h3>" . __('Bookmarks','avia_framework') . "</h3>";
				echo "<ul>";
