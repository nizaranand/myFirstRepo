...
jQuery(document).ready(function($) {
	...
	$('.add-row').bind("mousedown", (function(event){
		...
		$('#gs-table-slides tr:last td div.gs_slide_img_url input').attr("value","").attr("id","gs_slide_img_url_"+highestID).attr("name","purevision_options[gs_slide_img_url_"+highestID+"]");
	...
	function addUploader(tableOrRow, rowID) {
		...
		'uploader': '../wp-content/themes/purevision/scripts/admin/uploadify/uploadify.swf',
		'script': '../wp-content/themes/purevision/scripts/admin/uploadify/uploadify.php',
		'folder': '../wp-content/themes/purevision/sliders/flashmo/grid_slider/photos',
		'cancelImg': '../wp-content/themes/purevision/scripts/admin/uploadify/cancel.png',
...
jQuery(document).ready(function($) {
	...
	$('.add-row').bind("mousedown", (function(event){
		...
		$('#pm-table-slides tr:last td input').attr("value","").attr("id","pm_slide_img_url_"+highestID).attr("name","purevision_options[pm_slide_img_url_"+highestID+"]");
		// Update slide's info text
	...
	function addUploader(tableOrRow, rowID) {
		...
		'uploader': '../wp-content/themes/purevision/scripts/admin/uploadify/uploadify.swf',
		'script': '../wp-content/themes/purevision/scripts/admin/uploadify/uploadify.php',
		'folder': '../wp-content/themes/purevision/sliders/piecemaker/images',
		'cancelImg': '../wp-content/themes/purevision/scripts/admin/uploadify/cancel.png',
		'fileDesc': 'Only images with extensions: *.jpg, *.jpeg, *.png, *.gif are allowed',
		'fileExt': '*.jpg;*.jpeg;*.png;*.gif',
		'sizeLimit': 2097152, // 2 MB file size limit
...
jQuery(document).ready(function($) {
	...
	$('.add-image-row').bind("mousedown", (function(event){
		...
		$('#pm2-table-slides tr:last td div.pm2_slide_img_url input').attr("value","").attr("id","pm2_slide_img_url_"+highestID).attr("name","purevision_options[pm2_slide_img_url_"+highestID+"]");
	...
	function addUploader(tableOrRow, rowID) {
		...
		'uploader': '../wp-content/themes/purevision/scripts/admin/uploadify/uploadify.swf',
		'script': '../wp-content/themes/purevision/scripts/admin/uploadify/uploadify.php',
		'folder': '../wp-content/themes/purevision/sliders/piecemaker_2/contents',
		'cancelImg': '../wp-content/themes/purevision/scripts/admin/uploadify/cancel.png',
		'fileDesc': 'Only images with extensions: *.jpg, *.jpeg, *.png, *.gif are allowed',
		'fileExt': '*.jpg;*.jpeg;*.png;*.gif',
		'sizeLimit': 2097152, // 2 MB file size limit
...
jQuery(document).ready(function($) {
	...
	$('.add-row').bind("mousedown", (function(event){
		...
		// Update Uplodify ID's
		$('#c1-table-slides tr:last td textarea').attr("value","").attr("id","c1_slide_img_url_"+highestID).attr("name","purevision_options[c1_slide_img_url_"+highestID+"]");
	...
	function addUploader(tableOrRow, rowID) {
		...
		'uploader': '../wp-content/themes/purevision/scripts/admin/uploadify/uploadify.swf',
		'script': '../wp-content/themes/purevision/scripts/admin/uploadify/uploadify.php',
		'folder': '../wp-content/themes/purevision/sliders/cycle/cycle1/images',
		'cancelImg': '../wp-content/themes/purevision/scripts/admin/uploadify/cancel.png',
		'fileDesc': 'Only images with extensions: *.jpg, *.jpeg, *.png, *.gif are allowed',
		'fileExt': '*.jpg;*.jpeg;*.png;*.gif',
		'sizeLimit': 2097152, // 2 MB file size limit
...
jQuery(document).ready(function($) {
	...
	$('.add-row').bind("mousedown", (function(event){
		...
		$('#c2-table-slides tr:last td div.c2_slide_img_url input').attr("value","").attr("id","c2_slide_img_url_"+highestID).attr("name","purevision_options[c2_slide_img_url_"+highestID+"]");
	...
	function addUploader(tableOrRow, rowID) {
		...
		'uploader': '../wp-content/themes/purevision/scripts/admin/uploadify/uploadify.swf',
		'script': '../wp-content/themes/purevision/scripts/admin/uploadify/uploadify.php',
		'folder': '../wp-content/themes/purevision/sliders/cycle/cycle2/images',
		'cancelImg': '../wp-content/themes/purevision/scripts/admin/uploadify/cancel.png',
		'fileDesc': 'Only images with extensions: *.jpg, *.jpeg, *.png, *.gif are allowed',
		'fileExt': '*.jpg;*.jpeg;*.png;*.gif',
		'sizeLimit': 2097152, // 2 MB file size limit
