...
<?php		    printf(__('<span class="time">%1$s</span> on <a href="#comment-%2$s" title="">%3$s</a>', 'purevision'), get_comment_time(__('g:i a')), get_comment_ID(), get_comment_date(__('F j, Y')) );
