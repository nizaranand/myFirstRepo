...
class pureVISION_Theme_Options {
	...
	function purevision_generate_options_page() {
		...
		<div id="purevision-metaboxes-general" class="wrap">
		    ...
		    <h2 style="padding:17px 0 10px;"><?php printf( __('Options <small>(version %1$s)</small>', 'purevision'), '1.8.0' ); ?></h2>
<?php
...
<?php	}
	...
	function help_options_contentbox( $options ) { ?>
		...
		<ul style="list-style-type:none; margin:5px 5px 10px 20px;">
		    ...
		    <li><?php echo '<div><a href="http://themeforest.net/user/internq7/" target="_blank">'.esc_html__('Contact the Author', 'purevision').'</a></div>'; ?></li>
		</ul>
<?php	}
	...
	function general_options_contentbox( $options ) {
		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<?php printf( __('Enable %1$sprettyPhoto%2$s script. In case of conflicts with some other lightbox plugins you may wish to disable the %1$sprettyPhoto%2$s script. This script is automatically disabled if you installed and activated the %3$sWP-prettyPhoto%4$s plugin.', 'purevision'), '<a href="http://www.no-margin-for-errors.com/projects/prettyphoto-jquery-lightbox-clone/" target="_blank" title="Go to prettyPhoto website">', '</a>', '<a href="http://wordpress.org/extend/plugins/wp-prettyphoto/" target="_blank" title="Go to WP-prettyPhoto plugin website">', '</a>'); ?>
				</label>
			    </td>
			</tr>
			<tr valign="top">
		...
		<table class="form-table" style="background-color:#F9F9F9; border:1px solid #DDDDDD;">
			...
			<tr valign="top">
				...
				<select name="purevision_options[current_slider]" id="current_slider">
				    <option value="1"<?php echo ($current_slider == '1') ? ' selected="selected"' : ''; ?>><?php esc_html_e('1. Flashmo Grid Slider', 'purevision'); ?></option>
				    <option value="2"<?php echo ($current_slider == '2') ? ' selected="selected"' : ''; ?>><?php esc_html_e('2. Piecemaker', 'purevision'); ?></option>
				    <option value="3"<?php echo ($current_slider == '3') ? ' selected="selected"' : ''; ?>><?php esc_html_e('3. Piecemaker 2', 'purevision'); ?></option>
				    <option value="4"<?php echo ($current_slider == '4') ? ' selected="selected"' : ''; ?>><?php esc_html_e('4. Cycle 1 (full width image)', 'purevision'); ?></option>
				    <option value="5"<?php echo ($current_slider == '5') ? ' selected="selected"' : ''; ?>><?php esc_html_e('5. Cycle 2 (image with text)', 'purevision'); ?></option>
				    <option value="6"<?php echo ($current_slider == '6') ? ' selected="selected"' : ''; ?>><?php esc_html_e('6. No Slider', 'purevision'); ?></option>
				</select>
				<div class="clear"></div>
				<div class="submit" style="padding:10px 0 0 80px; float:left; clear:both;">
				    <input type="hidden" id="purevision_submit" value="1" name="purevision_submit"/>
...
<?php		if ( $current_slider == '1' ) :
    ...
    <?php		    foreach( $gs_slides_array as $position=>$slide_row_number ) : ?>
				<tr id="<?php echo $slide_row_number; ?>" class="row-style">
					...
					<div class="gs_slide_img_url" style="padding:7px 5px 0 0; float:left; display:inline;">
					    <label for="gs_slide_img_url_<?php echo $slide_row_number; ?>" style="font-weight:bold;"><?php esc_html_e('Image:', 'purevision'); ?></label>
					    <input name="purevision_options[gs_slide_img_url_<?php echo $slide_row_number; ?>]" type="text" id="gs_slide_img_url_<?php echo $slide_row_number; ?>" name="purevision_options[gs_slide_img_url_<?php echo $slide_row_number; ?>]" value="<?php if ($options['gs_slide_img_url_'.$slide_row_number]){ echo esc_url($options['gs_slide_img_url_'.$slide_row_number]); }?>" size="40" />
					</div>
    ...
    <?php		    endforeach; ?>
			...
			<tbody>
				...
				<td style="padding:10px 10px 10px 20px; width:100%" valign="top">
				    <div class="gs_slide_img_url" style="padding:7px 5px 0 0; float:left; display:inline;">
					<label for="gs_slide_img_url_999" style="font-weight:bold;"><?php esc_html_e('Image:', 'purevision'); ?></label>
					<input name="purevision_options[gs_slide_img_url_999]" type="text" id="gs_slide_img_url_999" name="purevision_options[gs_slide_img_url_999]" value="" size="40" />
				    </div>
...
<?php			    foreach( $pm_slides_array as $position=>$slide_row_number ) : ?>
				<tr id="<?php echo $slide_row_number; ?>" class="row-style">
					...
					<p style="font-weight:bold;"><?php esc_html_e('Edit the info text, erase all for none:', 'purevision'); ?></p>
					...
					<p><span class="description" style="margin:20px 0;"><?php esc_html_e("Study the above text for slider's specific syntax", 'purevision'); ?></span></p>
				    </td>
				    <td style="padding:0 5px; width:20%" valign="top">
					<p style="font-weight:bold;"><?php esc_html_e('Upload Slide:', 'purevision'); ?></p>
					<input id="pm_slide_img_url_<?php echo $slide_row_number; ?>" name="purevision_options[pm_slide_img_url_<?php echo $slide_row_number; ?>]" style=" margin: 5px 0;" type="text" size="20"
...
<?php			    endforeach; ?>
			...
			<tbody>
				...
				<td style="padding:0 5px; width:20%" valign="top">
				    <p style="font-weight:bold;"><?php esc_html_e('Upload Slide:', 'purevision'); ?></p>
				    <input id="pm_slide_img_url_999" name="purevision_options[pm_slide_img_url_999]" style=" margin: 5px 0;" type="text" size="20" value="" />
				    <div class="uploadify" style="padding-top:7px;">
					<input type="file" name="uploadify-999" id="uploadify-999" />
				    </div>
...
<?php					// If Image Slide
					if ( $options['pm2_slide_type_'.$slide_row_number] == 'image') : ?>
						<div class="pm2_slide_img_url" style="padding:7px 5px 0 0; float:left; display:inline;">
						    ...
						    <input name="purevision_options[pm2_slide_img_url_<?php echo $slide_row_number; ?>]" type="text" id="pm2_slide_img_url_<?php echo $slide_row_number; ?>" name="purevision_options[pm2_slide_img_url_<?php echo $slide_row_number; ?>]" value="<?php if ($options['pm2_slide_img_url_'.$slide_row_number]){ echo esc_url($options['pm2_slide_img_url_'.$slide_row_number]); }?>" size="50" />
						</div>
						<div class="uploadify" style="padding-top:7px; width: 120px; float:left; display:inline;">
						    <input type="file" name="uploadify-<?php echo $slide_row_number; ?>" id="uploadify-<?php echo $slide_row_number; ?>" />
						</div>
...
<?php					// If Flash Slide
					elseif ( $options['pm2_slide_type_'.$slide_row_number] == 'flash') : ?> 
						...
						<div class="clear" style=""><span class="description" style="margin:20px 0; line-height:1.5; font-size:10px;"><?php esc_html_e('(Preview image to be loaded before the SWF file is shown)', 'purevision'); ?></span></div>
...
<?php					// If Video Slide
					elseif ( $options['pm2_slide_type_'.$slide_row_number] == 'video') : ?>
						...
						<div class="clear" style=""><span class="description" style="margin:20px 0; line-height:1.5; font-size:10px;"><?php esc_html_e('(Preview image to be loaded before the Video file is shown)', 'purevision'); ?></span></div>
						<div class="file-uploaded" id="file-uploaded-<?php echo $slide_row_number; ?>" style="clear:both; padding-left:5px; line-height:24px; color:green"></div>
						<div class="pm2_slide_img_title" style="padding:10px 0 0; clear:both;">
						    <label for="pm2_slide_img_title_<?php echo $slide_row_number; ?>" style="font-weight:bold;"><?php esc_html_e('Title Attribute:', 'purevision'); ?> </label>
						    <input name="purevision_options[pm2_slide_img_title_<?php echo $slide_row_number; ?>]" type="text" id="pm2_slide_img_title_<?php echo $slide_row_number; ?>" value="<?php echo esc_attr($options['pm2_slide_img_title_'.$slide_row_number]); ?>" size="40" /><br />
...
<?php			    endforeach; ?>
			...
			<tbody>
				...
				<td style="padding:10px 10px 10px 20px; width:100%" valign="top">
					...
					<input name="purevision_options[pm2_slide_img_url_999]" type="text" id="pm2_slide_img_url_999" name="purevision_options[pm2_slide_img_url_999]" value="" size="50" />
				    </div>
				    <div class="uploadify" style="padding-top:7px; float:left; display:inline;">
					<input type="file" name="uploadify-999" id="uploadify-999" />
				    </div>
...
<?php		elseif ( $current_slider == '4' ) :
    ...
    <?php		    foreach( $c1_slides_array as $position=>$slide_row_number ) : ?>
				<tr id="<?php echo $slide_row_number; ?>" class="row-style">
					...
					<p style="font-weight:bold;"><?php esc_html_e('Slide Image:', 'purevision'); ?></p>
					<textarea style="width: 98%; font-size: 12px;" id="c1_slide_img_url_<?php echo $slide_row_number; ?>" rows="2" cols="60" name="purevision_options[c1_slide_img_url_<?php echo $slide_row_number; ?>]"><?php if ($options['c1_slide_img_url_'.$slide_row_number]){ echo esc_url($options['c1_slide_img_url_'.$slide_row_number]); }?></textarea><br />
    ...
    <?php		    endforeach; ?>
			...
			<tbody>
				...
				<td style="padding:0 10px 10px 20px; width:100%" valign="top">
				    <p style="font-weight:bold;"><?php esc_html_e('Slide Image:', 'purevision'); ?></p>
				    <textarea style="width: 98%; font-size: 12px;" id="c1_slide_img_url_999" rows="2" cols="60" name="purevision_options[c1_slide_img_url_999]"></textarea><br />
...
<?php		elseif ( $current_slider == '5' ) :
    ...
    <?php		    foreach( $c2_slides_array as $position=>$slide_row_number ) : ?>
				<tr id="<?php echo $slide_row_number; ?>" class="row-style">
					...
					<div class="c2_slide_img_url" style="padding:7px 5px 0 0; float:left; display:inline;">
					    <label for="c2_slide_img_url_<?php echo $slide_row_number; ?>" style="font-weight:bold;"><?php esc_html_e('Image:', 'purevision'); ?></label>
					    <input name="purevision_options[c2_slide_img_url_<?php echo $slide_row_number; ?>]" type="text" id="c2_slide_img_url_<?php echo $slide_row_number; ?>" name="purevision_options[c2_slide_img_url_<?php echo $slide_row_number; ?>]" value="<?php if ($options['c2_slide_img_url_'.$slide_row_number]){ echo esc_url($options['c2_slide_img_url_'.$slide_row_number]); }?>" size="40" />
					</div>
					<div class="uploadify" style="padding-top:7px; width: 120px; float:left; display:inline;">
					    <input type="file" name="uploadify-<?php echo $slide_row_number; ?>" id="uploadify-<?php echo $slide_row_number; ?>" />
					</div>
    ...
    <?php		    endforeach; ?>
			...
			<tbody>
				...
				<td style="padding:10px 10px 10px 20px; width:100%" valign="top">
				    <div class="c2_slide_img_url" style="padding:7px 5px 0 0; float:left; display:inline;">
					<label for="c2_slide_img_url_999" style="font-weight:bold;"><?php esc_html_e('Image:', 'purevision'); ?></label>
					<input name="purevision_options[c2_slide_img_url_999]" type="text" id="c2_slide_img_url_999" name="purevision_options[c2_slide_img_url_999]" value="" size="40" />
				    </div>
				    <div class="uploadify" style="padding-top:7px; float:left; display:inline;">
					<input type="file" name="uploadify-999" id="uploadify-999" />
				    </div>
